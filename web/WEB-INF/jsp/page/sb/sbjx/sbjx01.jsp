...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 设备缺陷故障记录录入</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>设备缺陷故障记录录入</h2></div>
        <hr />
        <form id="data_form" name="data_form" class="sub_form" style="width: 80%;">
            <table width="100%" class="table_input" border="0">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="qxbt" name="qxbt" maxlength="200" size="60" fn="notNull('标题','#data_form #qxbt')"/>
                        <span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                    <td width="20%" align="right">缺陷故障时间：</td>
                    <td>
                        <input type="text" id="qxsj" name="qxsj" data-role="date" fn="notNull('缺陷故障时间','#data_form #qxsj')"/>
                        <span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <textarea id="qxnr" name="qxnr" style="width:700px;height:400px;visibility:hidden;"></textarea>
                    </td>
                </tr>
            </table>
            <br />
