...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 整改时间审批</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>整改时间审批</h2></div>
        <form action="yhgl05.do" method="post" id="search_form" name="search_form" class="sub_form" style="width: 80%;">
                ...
                <tbody>
                    <c:forEach items="${result.value}" var="zgjl" varStatus="xh">
                        <tr>
                            ...
                            <td align="center">
                                <a href="#this" class="info" ind="${xh.index}">审批</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
        ...
        <div align="center" id="_cut_page">
            ...
            <form action="yhgl05.do" method="post" id="page_form" name="page_form">
        ...
        <div id="pzsx_dialog">
            <form id="pzsx_form">
                ...
                <table class="table_input" border="0" width="100%">
                    <tr>
                        <td width="40%" align="right">申请时限：</td>
                        <td width="60%">于 <span id="sqsx"></span> 完成整改</td>
                    </tr>
                    <tr>
                        <td width="40%" align="right">批准时限：</td>
                        <td width="60%">
                            <input type="text" id="pzsx_1" name="pzsx" fn="notNull('批准时限','#pzsx_form #pzsx_1')" data-role="date" size="12"/>
                            <input type="text" id="pzsx_h" name="pzsx_h" value="0" fn="isNum('批准时限(时)','#pzsx_form #pzsx_h')" size="3"/>时
