...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 设备状态修改</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>设备状态修改</h2></div>
                ...
                <tbody>
                    <c:forEach items="${result.value}" var="gysb" varStatus="xh">
                        <tr>
                            ...
                            <td align="center">
                                <a href="#this" class="info" ind="${xh.index}">修改</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
        ...
        <div id="gysb_dialog" title="修改设备状态">
            <table width="100%" class="table_input" border="0">
                <tr>
                    <td width="40%" align="right" style="background-color: #319ACF; color: white;">修改：</td>
                    <td></td>
                </tr>
                <tr>
