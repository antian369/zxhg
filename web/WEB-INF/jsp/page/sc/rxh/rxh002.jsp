...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 千方有效气耗原煤录入</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>千方有效气耗原煤录入</h2></div>
        <hr />
        <form id="data_form" name="data_form" class="sub_form" style="width: 80%;">
            <input type="hidden" id="xhpbh" name="xhpbh" value="102" />
            <table width="100%" border="0">
                ...
                <tr class="cl_tr">
                    <td width="33%">
                        中班：
                        <input type="text" id="zb" name="zb" size="12" fn="isNum('中班消耗量', '#data_form #zb')" value="0" />
                    </td>
                    <td width="33%">
                        夜班：
                        <input type="text" id="yb" name="yb" size="12" fn="isNum('夜班消耗量', '#data_form #yb')" value="0" />
                    </td>
                    <td>
                        白班：
                        <input type="text" id="bb" name="bb" size="12" fn="isNum('白班消耗量', '#data_form #bb')" value="0" />
                    </td>
                </tr>
                <tr class="cl_tr">
                    <td width="33%">
                        消耗品库存：
                        <input type="text" id="xhpkc" name="xhpkc" size="12" fn="isNum('消耗品库存', '#data_form #xhpkc')" value="0" />
                    </td>
                    <td colspan="2">
                        备注：
                        <input type="text" id="bz" name="bz" size="40" />
                    </td>
                </tr>
            </table>
        </form>
