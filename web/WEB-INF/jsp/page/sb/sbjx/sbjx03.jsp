...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 设备检修检查记录录入</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>设备检修检查记录录入</h2></div>
        <hr />
        <form id="data_form" name="data_form" class="sub_form" style="width: 80%;">
            <table width="100%" class="table_input" border="0">
                ...
                <tr>
                    <td width="20%" align="right">检修时间：</td>
                    <td>
                        <input type="text" id="jssj" name="jssj" data-role="date" fn="notNull('检修时间','#data_form #sgsj')"/>
                        <span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                    <td width="20%" align="right">检修备件材料费用：</td>
                    <td>
                        <input type="text" id="bpfy" name="bpfy" maxlength="10" size="20" fn="notNull('检修备件材料费用','#data_form #bpfy')"/>
                        <span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                    <td width="20%" align="right">人工费：</td>
                    <td>
                        <input type="text" id="rgf" name="rgf" maxlength="10" size="20" fn="notNull('人工费','#data_form #rgf')"/>
                        <span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                    <td width="20%" align="right">技术负责人：</td>
                    <td>
                        <input type="text" id="jsfzr" name="jsfzr" maxlength="50" size="40" fn="notNull('技术负责人','#data_form #jsfzr')"/>
                        <span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                    <td width="20%" align="right">参加检修人员：</td>
                    <td>
                        <textarea id="bpfy" name="bpfy" rows="5" cols="40" fn="notNull('参加检修人员','#data_form #bpfy')"></textarea>
                        <span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" id="jxbt" name="jxbt" maxlength="200" size="60" fn="notNull('标题','#data_form #jxbt')"/>
                        <span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <textarea id="jxnr" name="jxnr" style="width:700px;height:400px;visibility:hidden;"></textarea>
                    </td>
                </tr>
            </table>
            <br />
