...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 整改通报查询</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>整改通报查询</h2></div>
        <form action="yhgl01.do" method="post" id="search_form" name="search_form" class="sub_form" style="width: 80%;">
        ...
        <div id="container" style="width: 95%;margin: 10px auto 10px auto;">
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="yhxx_table">
                <thead>
                    <tr>
                        <th>隐患名称</th>
                        <th>隐患级别</th>
                ...
                <tbody>
                    <c:forEach items="${result.value}" var="yhxx" varStatus="xh">
                        <tr>
                            <td align="center">${yhxx.yhmc.value}</td>
                            <td align="center">${yhxx.yhjb_desc.value}</td>
                            <td align="center">${yhxx.yhlb_desc.value}</td>
                            <td align="center">${yhxx.zgrxm.value}</td>
                            <td align="center" select="${yhxx.yhdw.value}" class="table_view_select" target_select="#yhdw"></td>
                            <td align="center">${yhxx.sqsx.value.detaled}</td>
                            <td align="center">${yhxx.pzsx.value.detaled}</td>
                            <td align="center">${yhxx.ly_desc.value}</td>
                            <td align="center">
        ...
        <div align="center" id="_cut_page">
            ...
            <form action="yhgl01.do" method="post" id="page_form" name="page_form">
                ...
                <input type="hidden" name="jcrxm" value="${param.jcrxm}" />
            </form>
            <%-- 页码生成 end --%>
        </div>
        <%-- 详细信息 --%>
        <div id="yhxx_dialog" title="隐患详细信息">
            <table width="100%" class="table_input yh" border="0" id="yhjc_table">
                <tr>
                    <td width="30%" align="right" style="background-color: #319ACF; color: white;">安全查询信息：</td>
                    <td></td>
                </tr>
                <tr>
                    <td width="40%" align="right">检查人姓名：</td>
                ...
                <tr>
                    ...
                    <td width="60%" id="jclx_desc"></td>
                </tr>
                <tr>
                    <td width="40%" align="right">检查时间：</td>
                    <td width="60%" id="jcsj"></td>
                </tr>
            </table>
            <table width="100%" class="table_input yh" border="0" id="yhsg_table">
                <tr>
            ...
            <table width="100%" class="table_input yh" border="0" id="zsxb_table">
                <tr>
                    <td width="30%" align="right" style="background-color: #319ACF; color: white;">自述旬报信息：</td>
                    <td></td>
                </tr>
                <tr>
                    <td width="40%" align="right">填报人姓名：</td>
                    <td width="60%" id="tbrxm"></td>
                </tr>
                <tr>
                    <td width="40%" align="right">填报人职务：</td>
                    <td width="60%" id="zw_desc"></td>
                </tr>
                <tr>
                    <td width="40%" align="right">填报单位：</td>
                    <td width="60%">
                        <select id="tbdw" name="tbdw" disabled="disabled">
                            <c:forEach items="${deps.value}" var="dep">
                                <option value="${dep.dep_id.value}">${dep.dep_name.value}</option>
                            </c:forEach>
                        </select>
                ...
                <tr>
                    ...
                    <td width="60%" id="fggz"></td>
                </tr>
                <tr>
                    <td width="40%" align="right">填报时间：</td>
                    <td width="60%" id="tbsj"></td>
                </tr>
            </table>
