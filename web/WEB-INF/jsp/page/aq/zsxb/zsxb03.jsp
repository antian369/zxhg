...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 延时申请</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>延时申请</h2></div>
        <form action="zsxb03.do" method="post" id="search_form" name="search_form" class="sub_form" style="width: 80%;">
            ...
            <table width="100%" border="0">
                <tr>
                    ...
                    <td>
                        ...
                        <span style="color: red">提示：只能查询本单位的自述旬报</span>
                    </td>
                </tr>
            </table>
        </form>
                ...
                <tbody>
                    <c:forEach items="${result.value}" var="zgjl" varStatus="xh">
                        <tr>
                            ...
                            <td align="center">
                                <a href="#this" class="info" ind="${xh.index}">延时申请</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
        ...
        <div align="center" id="_cut_page">
            ...
            <form action="zsxb03.do" method="post" id="page_form" name="page_form">
                ...
                <input type="hidden" id="yhdw" name="yhdw" value="${sessionScope.ses.dep_id.value}" />
                <input type="hidden" id="ly" name="ly" value="2" /><%-- 来源：自述旬报 --%>
                <input type="hidden" id="zgjg" name="zgjg" value="0" /><%-- 整改结果：正在整改 --%>
                <input type="hidden" id="zt" name="zt" value="1" /><%-- 隐患状态：正在整改 --%>
            </form>
            <%-- 页码生成 end --%>
        </div>
