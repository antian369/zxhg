 ...
 * 查询自述旬报
 * S12004
 * 说明：参数 zt yhmc yhlb yhjb yhdw tbrxm do(是否执行查询)
 * @author Asus
 */
@Service
public class PageZsxbYh extends BaseService {
    ...
    public void execute(AbstractCommonData in, AbstractCommonData inHead,
        ...
        if (!StringUtil.isNull(in.getStringValue("tbrxm"))) {
            args[1] = "%" + in.getStringValue("tbrxm") + "%";
        } else {
            args[1] = "";
        }
        ...
        in.putStringValue("sql", "page_zsxb_yh");
