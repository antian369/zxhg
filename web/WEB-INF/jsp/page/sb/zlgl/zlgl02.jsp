...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 工艺流程管理</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>工艺流程管理</h2></div>
        ...
        <div id="gylc_dialog" title="工艺流程新增">
            <form id="gylc_data">
                <table width="100%" class="table_input" border="0">
                    <tr>
                        <td width="40%" align="right">工艺流程编号：</td>
                        <td width="60%">
                            <input type="text" id="gybh" name="gybh" maxlength="20" fn="isNum('工艺流程编号','#gylc_data #gybh')"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="40%" align="right">工艺流程名称：</td>
                        <td width="60%">
                            <input type="text" id="gymc" name="gymc" maxlength="80" fn="notNull('工艺流程名称','#gylc_data #gymc')"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="60%">
                            <textarea id="gyms" name="gyms" rows="5" cols="40" maxlength="500" fn="notNull('工艺流程描述','#gylc_data #gyms')"></textarea>
                        </td>
                    </tr>
                </table>
            </form>
