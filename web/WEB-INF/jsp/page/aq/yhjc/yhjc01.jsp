...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 安全检查登记</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>安全检查登记</h2></div>
        <hr />
        <form id="data_form" name="data_form" class="sub_form" style="width: 80%;">
            <table width="100%" class="table_input" border="0">
                <tr>
                    ...
                    <td width="60%">
                        <input type="hidden" id="jcr" name="jcr" value="${sessionScope.ses.username.value}" />
                        <input type="text" id="jcrxm" name="jcrxm" size="40" fn="notNull('检查人姓名','#data_form #jcrxm')" value="${sessionScope.ses.name.value}"/>
                ...
                <tr>
                    ...
                    <td width="60%">
                        <select id="jclx" name="jclx">
                            <c:forEach items="${requestScope['aq_yh_yhjc.jclx']}" var="par">
                ...
                <tr>
                    ...
                    <td width="60%">
                        <input type="text" id="jcsj" name="jcsj" data-role="date" fn="notNull('检查时间','#data_form #jcsj')" />
                        <span style="color: red;">*</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="60%">
                        ...
                        <input type="text" id="pzsx_h" name="pzsx_h" value="0" fn="isNum('批准整改完成时间(时)','#data_form #pzsx_h')" size="3"/>时
                        <span style="color: red;">*</span>
                    </td>
                </tr>
            </table>
