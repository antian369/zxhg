...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 私信查询</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>私信查询</h2></div>
            ...
            <table width="100%" border="0">
                <tr>
                    <td width="60%" align="right">
                        私信标题：
                        <input type="text" id="sxbt" name="sxbt" />
                    </td>
                    <td>
        ...
        <div id="container" style="width: 95%;margin: 10px auto 10px auto;">
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="sx_table">
                <thead>
                    <tr>
                        <th>公告标题</th>
                        <th>发布时间</th>
                ...
                <tbody>
                    <c:forEach items="${result.value}" var="sx" varStatus="xh">
                        <tr>
                            <td align="center">${sx.sxbt.value}</td>
                            <td align="center">${sx.fsrxm.value}</td>
                            <td align="center">${sx.fssj.value}</td>
                            <td align="center">
        ...
        <div id="sx_dialog" title="私信详细信息">
            <table width="90%" class="table_input" border="0">
                <tr>
                    <td width="25%" align="right">私信标题：</td>
                    <td id="sxbt"></td>
                </tr>
                <tr>
                    <td width="25%" align="right">发送人：</td>
                    <td id="fsrxm"></td>
                </tr>
                <tr>
                    <td width="25%" align="right">发送时间：</td>
                    <td id="fssj"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td id="sxnr" colspan="2"></td>
                </tr>
            </table>
        </div>
        <div id="hf_dialog" title="回复私信">
            <table width="90%" class="table_input" border="0">
                <tr>
                ...
                <tr>
                    <td width="25%" align="right">内容：</td>
                    <td>
                        <textarea id="hfnr" rows="8" cols="40"></textarea>
                    </td>
                </tr>
            </table>
        </div>
