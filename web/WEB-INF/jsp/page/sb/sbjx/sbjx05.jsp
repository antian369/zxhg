...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 设备技改技措录入</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>设备技改技措录入</h2></div>
        <hr />
        <form id="data_form" name="data_form" class="sub_form" style="width: 80%;">
            <table width="100%" class="table_input" border="0">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="jgbt" name="jgbt" maxlength="200" size="60" fn="notNull('标题','#data_form #jgbt')"/>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <textarea id="jgnr" name="jgnr" style="width:700px;height:400px;visibility:hidden;"></textarea>
                    </td>
                </tr>
            </table>
            <br />
