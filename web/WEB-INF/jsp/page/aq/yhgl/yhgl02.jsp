...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 自述旬报查询</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>自述旬报查询</h2></div>
        <form action="yhgl02.do" method="post" id="search_form" name="search_form" class="sub_form" style="width: 80%;">
            ...
            <table width="100%" border="0">
                ...
                <tr>
                    ...
                    <td width="25%">
                        填报人姓名：<input type="text" id="tbrxm" name="tbrxm" size="8"/>
                    </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
        ...
        <div id="container" style="width: 95%;margin: 10px auto 10px auto;">
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="zsxb_table">
                <thead>
                    <tr>
                        <th>隐患名称</th>
                        <th>隐患级别</th>
                ...
                <tbody>
                    <c:forEach items="${result.value}" var="zsxb" varStatus="xh">
                        <tr>
                            <td align="center">${zsxb.yhmc.value}</td>
                            <td align="center">${zsxb.yhjb_desc.value}</td>
                            <td align="center">${zsxb.yhlb_desc.value}</td>
                            <td align="center">${zsxb.tbrxm.value}</td>
                            <td align="center" select="${zsxb.yhdw.value}" class="table_view_select" target_select="#yhdw"></td>
                            <td align="center">${zsxb.zt_desc.value}</td>
                            <td align="center">${zsxb.tbsj.value.detaled}</td>
                            <td align="center">
        ...
        <div align="center" id="_cut_page">
            ...
            <form action="yhgl02.do" method="post" id="page_form" name="page_form">
                ...
                <input type="hidden" name="tbrxm" value="${param.tbrxm}" />
            </form>
            <%-- 页码生成 end --%>
        </div>
        <%-- 详细信息 --%>
        <div id="zsxb_dialog" title="自述旬报详细信息">
