...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    ...
    <body>
        ...
        <form action="zsxb02.do" method="post" id="search_form" name="search_form" class="sub_form" style="width: 80%;">
        ...
        <div align="center" id="_cut_page">
            ...
            <form action="zsxb02.do" method="post" id="page_form" name="page_form">
