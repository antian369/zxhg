...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 工艺日志查询</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>工艺日志查询</h2></div>
        <form action="gyrz02.do" method="post" id="search_form" name="search_form" class="sub_form" style="width: 80%;">
        ...
        <div id="container" style="width: 95%;margin: 10px auto 10px auto;">
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="gyrz_table">
                <thead>
                    <tr>
                        <th>主题</th>
                        <th>部门</th>
                ...
                <tbody>
                    <c:forEach items="${result.value}" var="gyrz" varStatus="xh">
                        <tr>
                            <td align="center">${gyrz.jczt.value}</td>
                            <td align="center">${gyrz.lrdw.value}</td>
                            <td align="center">${gyrz.jb_desc.value}</td>
                            <td align="center">${gyrz.lrrxm.value}</td>
                            <td align="center">${gyrz.lrsj.value}</td>
                            <td align="center">
        ...
        <div align="center" id="_cut_page">
            ...
            <form action="gyrz02.do" method="post" id="page_form" name="page_form">
        ...
        <div id="gyrz_dialog" title="工艺日志信息">
