...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 安全查检查询</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>安全查检查询</h2></div>
        <form action="yhgl04.do" method="post" id="search_form" name="search_form" class="sub_form" style="width: 80%;">
            ...
            <table width="100%" border="0">
                ...
                <tr>
                    ...
                    <td width="25%">
                        检查人：<input type="text" id="jcrxm" name="jcrxm" size="8"/>
                    </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
        ...
        <div id="container" style="width: 95%;margin: 10px auto 10px auto;">
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="yhjc_table">
                <thead>
                    <tr>
                        <th>隐患名称</th>
                        <th>隐患级别</th>
                ...
                <tbody>
                    <c:forEach items="${result.value}" var="yhjc" varStatus="xh">
                        <tr>
                            <td align="center">${yhjc.yhmc.value}</td>
                            <td align="center">${yhjc.yhjb_desc.value}</td>
                            <td align="center">${yhjc.yhlb_desc.value}</td>
                            <td align="center">${yhjc.jcrxm.value}</td>
                            <td align="center" select="${yhjc.yhdw.value}" class="table_view_select" target_select="#yhdw"></td>
                            <td align="center">${yhjc.zt_desc.value}</td>
                            <td align="center">${yhjc.jcsj.value.detaled}</td>
                            <td align="center">
        ...
        <div align="center" id="_cut_page">
            ...
            <form action="yhgl04.do" method="post" id="page_form" name="page_form">
        ...
        <%-- 详细信息 --%>
        <div id="yhjc_dialog" title="自述旬报详细信息">
