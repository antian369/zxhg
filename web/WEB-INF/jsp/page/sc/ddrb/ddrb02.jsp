...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center">
            <h2><span id="scrq" style="font-family:Tahoma,Arial,Helvetica,sans-serif"></span>生产调度日报</h2></div>
        <hr />
        <form id="search_form" name="search_form" class="sub_form" style="width: 80%;">
            <div align="center">
                日期：
                <input type="text" id="scrq_input" name="scrq_input" data-role="date" size="12" fn="notNull('日期', '#search_form #scrq')" />
            </div>
        </form>
        ...
        <div style="width: 90%; margin: 0px auto 5px auto;">
            <div style="width: 200px; float: left">审核人：<span id="bcrxm"></span></div>
            <div style="width: 300px; float: left">备注：<span id="bz"></span></div>
            <div style="width: 200px; float: right">审核时间：<span id="bcsj"></span></div>
        </div>
        <!-- InstanceEndEditable -->
    </body>
    <!-- InstanceEnd --></html>
