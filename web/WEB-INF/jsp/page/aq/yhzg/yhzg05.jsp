...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 整改延时审批</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>整改延时审批</h2></div>
        <hr />
        ...
        <%-- 隐患验收 --%>
        <div id="ysbz_dialog" title="整改延时审批">
            <form id="ysbz_form">
                <table width="100%" class="tablelist" style="margin: 10px auto">
                    <tr>
                        <td width="40%" align="right">批准延时：</td>
                        <td>
                            <%-- 3为批准延时 --%>
                            <input type="radio" id="ystg_y" name="ystg" value="3" checked="checked" /><label for="ystg_y">是</label>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <%-- 1为未超时 --%>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea id="ysbz" name="ysbz" rows="5" cols="40" fn="notNull('备注','#ysbz_dialog #ysbz')"></textarea>
                        </td>
                    </tr>
                </table>
            </form>
