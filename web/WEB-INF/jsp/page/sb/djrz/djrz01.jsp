...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 设备点检日志查询</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>设备点检日志查询</h2></div>
        <form action="zlgl01.do" method="post" id="search_form" name="search_form" class="sub_form" style="width: 80%;">
            ...
            <table width="100%" border="0">
                <tr>
                    ...
                    <td width="30%">
                        点检员：
                        <input type="text" id="djy" name="djy" />
                    </td>
                    <td>
