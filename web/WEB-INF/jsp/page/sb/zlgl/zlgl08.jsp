...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 新增设备资料</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>新增设备资料</h2></div>
        <hr />
        <form id="data_form" name="data_form" class="sub_form" style="width: 80%;">
            <table width="100%" class="table_input" border="0">
                ...
                <tr>
                    <td width="20%" align="right">资料标题：</td>
                    <td>
                        <input type="text" id="zlbt" name="zlbt" maxlength="200" size="60" fn="notNull('资料标题','#data_form #zlbt')"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <textarea id="zlnr" name="zlnr" style="width:700px;height:400px;visibility:hidden;"></textarea>
                    </td>
                </tr>
            </table>
            <br />
