...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 整改验收审批</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>整改验收审批</h2></div>
        <hr />
        ...
        <%-- 隐患验收 --%>
        <div id="ysbz_dialog" title="隐患验收">
            <form id="ysbz_form">
                <table width="100%" class="tablelist" style="margin: 10px auto">
                    <tr>
                        <td width="40%" align="right">验收通过：</td>
                        <td>
                            <%-- 5为验收通过 --%>
                            <input type="radio" id="ystg_y" name="ystg" value="5" checked="checked" /><label for="ystg_y">是</label>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <%-- 1为正在整改 --%>
                            <input type="radio" id="ystg_n" name="ystg" value="1" /><label for="ystg_n">否</label>
                        </td>
                    </tr>
                    <tr id="pzsx_tr">
                        <td width="40%" align="right">批准时限：</td>
                        <td width="60%">
                            <input type="text" id="pzsx_d" name="pzsx" data-role="date" fn="notNull('批准时限','#ysbz_dialog #pzsx_d')" size="12"/>
                            <input type="text" id="pzsx_h" name="pzsx_h" value="0" fn="isNum('批准时限(时)','#ysbz_dialog #pzsx_h')" size="1"/>时
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea id="ysbz" name="ysbz" rows="5" cols="40" fn="notNull('验收备注','#ysbz_dialog #ysbz')"></textarea>
                        </td>
                    </tr>
                </table>
            </form>
