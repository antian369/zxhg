...
<html><!-- InstanceBegin template="/Templates/work.dwt.jsp" codeOutsideHTMLIsLocked="false" -->
    <head>
        ...
        <title><%=SystemUtil.serverDesc%> -- 送乙二醇合成气量录入</title>
        <!-- InstanceEndEditable -->
    ...
    <body>
        ...
        <div style="margin: 10px auto 10px auto; text-align: center"><h2>送乙二醇合成气量录入</h2></div>
        <hr />
        <form id="data_form" name="data_form" class="sub_form" style="width: 80%;">
            <input type="hidden" id="cpbh" name="cpbh" value="012" />
            <table width="100%" border="0">
                ...
                <tr class="cl_tr">
                    <td width="33%">
                        库存：
                        <input type="text" id="kc" name="kc" size="12" fn="isNum('库存', '#data_form #kc')" value="0" />
                    </td>
                    <td colspan="2">
                        备注：
